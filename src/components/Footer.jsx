        ...
        <footer className="bg-gray-900 border-t border-gray-800">
            <div className="max-w-7xl mx-auto px-6 py-12">
                ...
                <div className="border-t border-gray-800 pt-6">
                    ...
                    <p className="text-xs text-gray-500 mt-4 text-left">Site criado por <a href="https://www.linkedin.com/in/matheuspachecouxdesign/" className="cursor-pointer font-bold hover:text-white">Matheus Pacheco</a> para fins educacionais</p>
